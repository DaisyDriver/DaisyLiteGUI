...
class PreviewWindow(QLabel):
	...
	def __init__(self, parent, camera):
		...
		# set no-feed image
		self.goat = QImage('resources/goat_320.png')
	...
	def frame_getter(self):
		...
		capturestream_array = PiRGBArray(self.camera, size = (320, 240))

		for frame in self.camera.capture_continuous(capturestream_array, format="rgb", use_video_port=True):
